        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a class="btn btn-primary btn-sm" href="{{ route('admin.profile') }}">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $admin->role }}</td>
                                <td>
                                    @if($admin->id == 1 || Auth::user()->role == 'editor' || Auth::user()->id == $admin->id)
                                        <button class="btn btn-secondary btn-sm" disabled>
                                            <i class="fas fa-trash fa-sm"></i>
                                        </button>
                                    @else
                                        <input type="hidden" id="delAdminLink{{$admin->id}}" value='{{ route("admin.delete_admin", ['id' => $admin->id]) }}'/>
