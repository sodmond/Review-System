...
<head>
    ...
    <title>{{ $title }} - {{ config('app.name', 'Review Management System') }}</title>
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin.home') }}">
                <div class="sidebar-brand-icon">
                    <img src="{{ asset('images/favicon/favicon-32x32.png') }}" alt="Logo">
                </div>
            ...
            <!-- Nav Item - Approved Reviews -->
            <li class="nav-item {{ $activePage == 'reviewsApproved' ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.reviews.approved') }}">
                    <i class="fas fa-fw fa-check"></i>
                    <span>Approved Reviews</span></a>
            </li>

            <!-- Nav Item - Pending Reviews -->
            <li class="nav-item {{ $activePage == 'reviewsPending' ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.reviews.pending') }}">
                    <i class="fas fa-fw fa-circle-notch"></i>
                    <span>Pending Reviews</span></a>
            </li>

            <!-- Nav Item - Registered Admin -->
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Imperial Crest Limited {{date('Y')}}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
