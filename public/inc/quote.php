...
define( "RECIPIENT_NAME", "QUOTE" );
define( "RECIPIENT_EMAIL", "contactus@yetedaservices.com" );
...
$mail_subject = 'Request Quote by ' . $name;
...
if ( $name && $senderEmail && $message ) {
  ...
  echo "<div class='inner success'><p class='success'>Thanks for requesting a quote from us. We will contact you ASAP!</p></div><!-- /.inner -->";
}else {
